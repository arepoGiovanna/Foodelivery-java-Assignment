...
public class testFoodelivery{
    ...
    public static void main(String[] args) throws java.io.IOException{
        ...
        Customer cust1 = new Customer(custName, phoneNum);
        ...
        if(chooseRole == 1){
            ...
            switch(chooseAction){
                ...
                case 2: System.out.println("===============================");
                        ...
                        if(userChoose == 1){
                            r.showDoofFood(userChoose);
                            System.out.println("=================================");
                            System.out.println("Please choose your food to order");
                            System.out.println("=================================");
                            int index = scan.nextInt();

                            r.getDoofFood(index-1);
                            System.out.println("how much do you want?");
                            System.out.print("> ");
                            int doofMany = scan.nextInt();
                            double doofTotal = (double) (r.howManyDoofs(index-1) * doofMany)  ;
                            System.out.println("Total is of" + r.getDoofFood(index-1) + "is RM " + doofTotal);
                            System.out.println("Please pay at the restaurant thank you.");
                            System.exit(0);
                        }else if(userChoose == 2){
                            r.showKrabbyFood(userChoose);
                            System.out.println("=================================");
                            System.out.println("Please choose your food to order");
                            System.out.println("=================================");
                            int index = scan.nextInt();

                            r.getKrabbyFood(index);
                            System.out.println("how much do you want?");
                            System.out.print("> ");
                            int krabMany = scan.nextInt();
                            double krabTotal = (double) (r.howManyKrabs(index-1) * krabMany)  ;
                            System.out.println("Total is of" + r.getKrabbyFood(index-1) + "is RM " + krabTotal);
                            System.out.println("Please pay at the restaurant thank you.");
                            System.exit(0);
                        }else if(userChoose == 3){
                            r.showBatFood(userChoose);
                            System.out.println("=================================");
                            System.out.println("Please choose your food to order");
                            System.out.println("=================================");
                            int index = scan.nextInt();

                            r.getBatFood(index-1);
                            System.out.println("how much do you want?");
                            System.out.print("> ");
                            int batMany = scan.nextInt();
                            double batTotal = (double) (r.howManyBat(index-1) * batMany)  ;
                            System.out.println("Total is of" + r.getBatFood(index-1) + "is RM " + batTotal);
                            System.out.println("Please pay at the restaurant thank you.");
                            System.exit(0);
                            break;
                        }
                ...
                case 2: System.out.print("\n");
                        ...
                        switch(chooseAction3){
                            ...
                            case 2: r.showKrabbyFood(chooseAction3);
                                    ...
                                    output.print(codeKrabs);
                                    output.print(KrabsFood);
                                    output.print(KrabsPrice);
                            ...
                            case 3: r.showBatFood(chooseAction3);
                                    ...
                                    output.print(codeBat);
                                    output.print(batFood);
                                    output.print(batPrice);
