...
public class Restaurant {
    ...
    public String getDoofFood(int index){
        return nameDoofFoodDrink.get(index);
    }

    public double howManyDoofs(int index){
        return PriceDoofFood.get(index);
    }

    public String getKrabbyFood(int index){
        return nameKrabbyFoodDrink.get(index);
    }

    public double howManyKrabs(int index){
        return PriceKrabbyFood.get(index);
    }

    public String getBatFood(int index){
        return nameBatFoodDrink.get(index);
    }

    public double howManyBat(int index){
        return PriceKrabbyFood.get(index);
    }
}